! function (t, e) {
    ...
    return function (t) {
        ...
        var i = this && this.__assign || function () {
            ...
            n = this && this.__spreadArrays || function () {
                ...
                var i = Array(t),
                    r = 0;
                for (e = 0; e < s; e++)
                    for (var n = arguments[e], o = 0, a = n.length; o < a; o++, r++) i[r] = n[o];
                return i
            };
            ...
            h = function () {
                function t(t) {
                    var e = this,
                        ...
                        T = t.observer;
                    this.percentage = 0, this.speed = 1, this.speedOption = 0, this.type = "increase", this.isEnd = !1, this.emptyColor = "#efefef", this.fillColor = "#6bd5c8", this.lineCap = "round", this.increaseValue = 0, this.frequency = 0, this.lastNumber = 0, this.prevProgress = 0, this.prevText = "0", this.textValue = 0, this.drawProgressAnimate = function () {
                        !1 === e.animation && (e.percentage = e.progress), e.isEnd = e.percentage === e.progress, e.ctx.clearRect(0, 0, e.size, e.size), e.drawBackground(), e.drawText(), e.drawProgress(), e.isEnd || ("increase" === e.type ? (e.accumulation(), e.requestAnimationFrame(e.drawProgressAnimate)) : "decrease" === e.type && (e.accumulation(), e.requestAnimationFrame(e.drawProgressAnimate)))
                        ...
                        if ("number" == typeof s) {
                            var h = 100 * s;
                            e.type = h > e.progress ? "increase" : "decrease", e.progress = h, e.optionProgress = s
                        }
                        r && (e.thickness = 2 * r), n && (e.textStyle = i(i({}, e.textStyle), n)), o && (e.size = 2 * o), "number" == typeof a && (e.speedOption = a)
                    }, this.size = 2 * (s || 200), this.arcStart = l, this.arcEnd = p, this.optionProgress = u, this.progress = 100 * u, this.text = f, this.el = r, this.thickness = 2 * (d || 12), this.fillThickness = 2 * g || this.thickness, this.animationEnd = O, this.onError = j, this.emptyColor = v, this.fillColor = m || this.fillColor, this.lineCap = x || this.lineCap, this.animation = b, this.textStyle = i({
                        size: "18px",
                        color: "#000",
                        x: this.size / 4,
                        y: this.size / 4
                    }, a), this.customText = k || [], this.observer = T, this.speedOption = C;
                    var E = "object" === o.type(this.fillColor) && !!this.fillColor.image;
                    this.init({
                        updateImg: E
                    })
                }
                return Object.defineProperty(t.prototype, "isEmptyProgressBig", {
                    ...
                    var e = this,
                        ...
                        i = s.notCreate,
                        r = s.updateImg;
                    this.createCanvas(i), this.setSpeed(), this.text && this.setIncreaseValue(), this.sourceLoad(r).then((function () {
                    ...
                    var s = this.size / 2;
                    e.style.width = s + "px", e.style.height = s + "px", this.canvas.width = this.size, this.canvas.height = this.size, this.canvas.style.width = s + "px", this.canvas.style.height = s + "px", this.canvas.style.width = "block", t || (e.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"))
                }, t.prototype.drawBackground = function () {
                    var t = this.ctx,
                        e = this.size / 2,
                        s = this.arcStart / 180 * a,
                        i = this.arcEnd / 180 * a;
                    t.beginPath(), t.lineWidth = this.thickness, t.lineCap = this.lineCap, t.strokeStyle = this.emptyColor;
                    var r = this.isEmptyProgressBig ? e - this.thickness : e - this.thickness - (this.fillThickness - this.thickness);
                    t.arc(e, e, r, s, i, !1), t.stroke(), t.closePath()
                    ...
                    var t = this.speedOption,
                        ...
                        i = this.prevProgress,
                        r = s > i ? s - i : i - s;
                    e && "number" == typeof e ? this.speed = r / (e / (1e3 / 60)) : "number" == typeof t && (this.speed = 1, this.speed += t > 0 ? t / 40 : t / 101), this.frequency = r / this.speed
                }, t.prototype.setIncreaseValue = function () {
                    var t = Number(this.text),
                        e = Number(this.prevText),
                        s = (t > e ? t - e : e - t) / this.frequency;
                    !o.isInt(this.text) || s % 2 && s % 5 || (s = s - 1 > 0 ? s -= 1 : 1), this.increaseValue = s
                    ...
                    if (!e) {
                        ...
                        return this.lastNumber = 9 === t ? 0 : t + 1, s > 1 ? this.textValue.toFixed(s - 1) + this.lastNumber : this.textValue.toFixed(0) + "." + this.lastNumber
                    }
                    return String(Math.floor(this.textValue))
                }, t.prototype.sourceLoad = function (t) {
                    var e = this;
                    return new Promise((function (s, i) {
                        if ("object" === o.type(e.fillColor) && t) {
                            e.drawBackground();
                    ...
                    else if ("object" === e && this.fillColor.image) {
                        var s = t.createPattern(this.fillImage, "no-repeat");
                        t.strokeStyle = s
                    } else {
                        for (var i = this.fillColor.gradient, r = t.createLinearGradient(0, 0, this.size, 0), n = i.length, a = 1 / n, h = 0, l = 0; l < n; l++) r.addColorStop(h, i[l]), h += a;
                        t.strokeStyle = r
                    }
                    ...
                    var t = this.ctx,
                        ...
                        i = s.start,
                        r = s.end;
                    t.beginPath(), t.lineWidth = this.fillThickness, t.lineCap = this.lineCap, this.setFillColor(t);
                    var n = this.isEmptyProgressBig ? e - this.fillThickness - (this.thickness - this.fillThickness) : e - this.fillThickness;
                    t.arc(e, e, n, i, r, !1), t.stroke(), t.closePath(), this.observer && this.observer(this.percentage, this.currentText), this.isEnd && this.animationEnd({
                    ...
                    t.font = "" + f + d + " " + u, t.fillStyle = o, t.textAlign = "center", t.textBaseline = "middle", t.fillText(s, 2 * h, 2 * c)
                    ...
                    e && s.push(i({
                        text: e
                    }, this.textStyle)), s = n(s, this.customText);
                    ...
                    var e = this;
                    this.prevProgress = this.progress, this.prevText = this.text;
                    var s = t.progress,
                        i = t.thickness,
                        n = t.textStyle,
                        a = t.size,
                        h = t.speed,
                        l = r(t, ["progress", "thickness", "textStyle", "size", "speed"]);
                    if (this.isEnd && this.prevProgress !== 100 * s) {
                        ...
                        var c = "object" === o.type(l.fillColor) && !l.fillColor.image;
                        this.init({
                            updateImg: c,
                            notCreate: !0
                        })
        ...
        Object.defineProperty(e, "__esModule", {
            ...
            return void 0 === t && (t = ""), 1 === t.split(".").length
        }, e.type = function (t) {
